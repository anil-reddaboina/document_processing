...
from doc_exception.custom_exception import DocumentPortalException
...
if __name__ == "__main__":
    ...
    pdf_path=r"/Users/admin/anil_reddaboina/ai_learning/document_processing/data/sample.pdf"
    class DummnyFile:
